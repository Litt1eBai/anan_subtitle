...
| `src/presentation/qt/overlay_renderer.py` | `src/presentation/qt/overlay_window.py` 周边辅助 | 绘制辅助 |`r`n| `src/presentation/qt/overlay_window_behavior.py` | `src/presentation/qt/overlay_window.py` 周边辅助 | 窗口 flags 与关闭动作辅助 |
